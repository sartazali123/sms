 ...
 * @author Asus
 */
public class BrokerLedger extends javax.swing.JFrame {

    /**
     * Creates new form BrokerLedger
     */
    public BrokerLedger() {
        initComponents();
        setTitle("Brokers Ledger");
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Brokerage Type");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        jLabel5.setText("Percentage Type");

        jLabel6.setText("Tag to Customer");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Brokers "));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BrokerLedger.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BrokerLedger().setVisible(true);
            }
        });
    }
